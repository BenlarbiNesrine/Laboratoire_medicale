# Generated by Django 2.2 on 2020-10-03 07:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('analyses', '0029_auto_20201002_1114'),
    ]

    operations = [
        migrations.CreateModel(
            name='AcinetobacterResult',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Nom_patient', models.CharField(max_length=40)),
                ('Horodatage_création_de_résultat', models.DateTimeField(blank=True, default=datetime.datetime.now)),
